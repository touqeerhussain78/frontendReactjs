              ...
              <div className='w-50 bg-white rounded p-3'>
                  <form onSubmit={handleUpdate}>
                      ...
                      <div className='mb-2'>
                          ...
                          <input type="text" placeholder='Enter Name' value={values.name} className='form-control' onChange={e => setValues({...values, name: e.target.value})} required />
                      </div>
                      <div className='mb-2'>
                          <label htmlFor="">Email</label>
                          <input type="email" placeholder='Enter email' value={values.email} className='form-control' onChange={e => setValues({...values, email: e.target.value})} required />
                      </div>
                      <div className='mb-2'>
                          <label htmlFor="">Phone</label>
                          <input type="text" placeholder='Enter phone' value={values.phone} className='form-control' onChange={e => setValues({...values, phone: e.target.value})} required />
                      </div>
                      <div className='mb-2'>
